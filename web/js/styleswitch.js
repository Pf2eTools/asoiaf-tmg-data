...
class StyleSwitcher {
	...
	getDayNightButtonText () {
		switch (this.currentStylesheet) {
			...
			case StyleSwitcher._STYLE_NIGHT: return "Day Mode";
		}
	}
	...
	cycleDayNightMode () {
		const newStyle = this.currentStylesheet === StyleSwitcher._STYLE_DAY ? StyleSwitcher._STYLE_NIGHT : StyleSwitcher._STYLE_DAY;
