...
class SourceUiUtil {
	...
	static render (options) {
		...
		const $stageInitial = $$`<div class="h-100 w-100 ve-flex-vh-center"><div class="ve-flex-col">
			...
			<div class="ui-source__row mb-2"><div class="ve-col-12 ve-flex-v-center">
				<span class="mr-2 ui-source__name help" title="A link to the original homebrew">Source URL</span>
				${$iptUrl}
			</div></div>
			<div class="ui-source__row mb-2"><div class="ve-col-12 ve-flex-v-center">
			...
			<div class="ui-source__row mb-2"><div class="ve-col-12 ve-flex-v-center">
				<span class="mr-2 ui-source__name help" title="A comma-separated list of people who converted the homebrew, e.g. 'John Doe, Joe Bloggs'">Converted By</span>
				${$iptConverters}
			</div></div>
